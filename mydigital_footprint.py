...
if page == "Home":
    ...
    if uploaded_image is not None:
        ...
        st.image("Olivier.jpg", width=100, caption="Default Image")
...
# Projects section
    ...
    with st.expander("🌐 THE VISIT OF PRISON"):
        st.write("explores the management and regulation of prison visits, focusing on visitor protocols, security measures using python.")
